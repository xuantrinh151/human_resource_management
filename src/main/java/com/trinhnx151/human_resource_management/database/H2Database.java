    ...
    CommandLineRunner initDatabase(DepartmentRepo departmentRepo, EmployeeRepo employeeRepo, RecordRepo recordRepo) {
        ...
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                Employee employeeA = new Employee(1L, "Code A", "NV A", true, "Image A", Timestamp.valueOf("2001-09-01 09:01:15"), 1000, Employee.Level.LEVEL_1, "nva@gmail.com", "123", "Phone A", Employee.Status.IN_USE, 1L);
                Employee employeeB = new Employee(2L, "Code B", "NV B", true, "Image B", Timestamp.valueOf("2000-10-01 09:01:15"), 1500, Employee.Level.LEVEL_2, "nvb@gmail.com", "123", "Phone B", Employee.Status.IN_USE, 1L);
                Employee employeeC = new Employee(3L, "Code C", "NV C", false, "Image C", Timestamp.valueOf("2002-11-01 09:01:15"), 2000, Employee.Level.LEVEL_3, "nvc@gmail.com", "123", "Phone C", Employee.Status.IN_USE, 1L);
                Employee employeeD = new Employee(4L, "Code D", "NV D", true, "Image D", Timestamp.valueOf("2001-12-01 09:01:15"), 1000, Employee.Level.LEVEL_1, "nvd@gmail.com", "123", "Phone D", Employee.Status.IN_USE, 2L);
                Employee employeE = new Employee(5L, "Code E", "NV E", false, "Image E", Timestamp.valueOf("2000-11-02 09:01:15"), 1500, Employee.Level.LEVEL_1, "nve@gmail.com", "123", "Phone E", Employee.Status.IN_USE, 2L);
                Employee employeeAA = new Employee(6L, "Code AA", "NV AA", true, "Image AA", Timestamp.valueOf("2002-11-01 09:01:15"), 2000, Employee.Level.LEVEL_2, "nvaa@gmail.com", "123", "Phone AA", Employee.Status.IN_USE, 2L);
                Employee employeeAAA = new Employee(7L, "Code AAA", "NV AAA", false, "Image AAA", Timestamp.valueOf("2001-09-01 09:01:15"), 1000, Employee.Level.LEVEL_3, "nvaaa@gmail.com", "123", "Phone AAA", Employee.Status.IN_USE, 3L);
                Employee employeeAAAA = new Employee(8L, "Code AAAA", "NV AAAA", true, "Image AAAA", Timestamp.valueOf("2000-11-01 09:01:15"), 1500, Employee.Level.LEVEL_1, "nvaaaa@gmail.com", "123", "Phone AAAA", Employee.Status.IN_USE, 3L);
                Employee employeeCC = new Employee(9L, "Code CC", "NV CC", true, "Image CC", Timestamp.valueOf("2002-09-01 09:01:15"), 2000, Employee.Level.LEVEL_10, "nvcc@gmail.com", "123", "Phone CC", Employee.Status.IN_USE, 3L);
                Employee employeeA1 = new Employee(10L, "Code A1", "NV A1", true, "Image A1", Timestamp.valueOf("2000-12-01 09:01:15"), 1500, Employee.Level.LEVEL_1, "nva1@gmail.com", "123", "Phone A1", Employee.Status.IN_USE, 3L);
                Employee employeeC1 = new Employee(11L, "Code C1", "NV C1", true, "Image C1", Timestamp.valueOf("2002-09-01 09:01:15"), 2000, Employee.Level.LEVEL_10, "nvc1@gmail.com", "123", "Phone C1", Employee.Status.IN_USE, 3L);
